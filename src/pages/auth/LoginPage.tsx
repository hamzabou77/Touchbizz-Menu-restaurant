...
import { UtensilsCrossed, ArrowRight, Lock, Mail, AlertCircle } from 'lucide-react';
      ...
      <div className="flex-1 flex items-center justify-center p-4 sm:p-6">
        <div className="bg-white rounded-2xl max-w-md w-full p-8 shadow-xl shadow-slate-200/50 border border-slate-100">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-slate-900 tracking-tight">TouchBizz Menu</h1>
            <p className="text-sm text-slate-500 mt-1">Connectez-vous à votre espace restaurateur</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="gerant@monrestaurant.com"
